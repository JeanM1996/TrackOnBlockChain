...
contract('SupplyChain', function(accounts) {
    ...
    // 1st Test
    it("Testing smart contract function plantedItem() that allows a farmer to plant coffee", async() => {
    ...
    */
        ...
        assert.equal(result.logs[0].event, 'Planted', 'Invalid event emitted') 
    ...
    it("Testing smart contract function growItem() that allows a farmer to grow coffee", async() => {
        ...
        assert.equal(result.logs[0].event, 'Matured', 'Invalid event emitted') 
    })    
        // 2nd Test
